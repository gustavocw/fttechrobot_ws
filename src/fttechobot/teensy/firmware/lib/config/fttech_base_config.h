...
// #define FTTECH_BASE DIFFERENTIAL_DRIVE // 2WD and Tracked robot w/ 2 motors
// #define FTTECH_BASE SKID_STEER      // 4WD robot
// #define FTTECH_BASE ACKERMANN       // Car-like steering robot w/ 2 motors
// #define FTTECH_BASE ACKERMANN1      // Car-like steering robot w/ 1 motor
#define FTTECH_BASE MECANUM         // Mecanum drive robot
