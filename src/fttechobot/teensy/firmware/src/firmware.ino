...
//header file for imu
#include "fttech_msgs/Imu.h"

#include "fttech_base_config.h"
#include "Motor.h"
...
Kinematics kinematics(Kinematics::FTTECH_BASE, MAX_RPM, WHEEL_DIAMETER, FR_WHEELS_DISTANCE, LR_WHEELS_DISTANCE);
...
void PIDCallback(const fttech_msgs::PID& pid);

ros::NodeHandle nh;

ros::Subscriber<geometry_msgs::Twist> cmd_sub("cmd_vel", commandCallback);
ros::Subscriber<fttech_msgs::PID> pid_sub("pid", PIDCallback);

fttech_msgs::Imu raw_imu_msg;
ros::Publisher raw_imu_pub("raw_imu", &raw_imu_msg);

fttech_msgs::Velocities raw_vel_msg;
...
void PIDCallback(const fttech_msgs::PID& pid)
{
    //callback function every time PID constants are received from fttech_pid for tuning
