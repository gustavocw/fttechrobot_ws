    ...
    heading_(0)
{
    ...
    velocity_subscriber_ = nh_.subscribe("raw_vel", 50, &fttechBase::velCallback, this);
}

void fttechBase::velCallback(const fttech_msgs::Velocities& vel)
{
